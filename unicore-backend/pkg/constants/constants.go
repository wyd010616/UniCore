...
const (
	...
	TestMySQLDSN  = "unicore:unicorepwd@tcp(localhost:18001)/unicore?charset=utf8&parseTime=True"
	RedisAddr     = "localhost:18002"
	RedisPassword = "unicorepwd"

	UserTableName         = "user"
	RegVerCodeTableName   = "rvc"
	ChPwdVerCodeTableName = "cpvc"
